...
LDSO_OBJECTS=\
stage1.o stage2.o avprintf-cb.o dprintf.o vdl-utils.o vdl-log.o vdl.o system.o alloc.o glibc.o gdb.o vdl-dl.o i386/machine.o i386/stage0.o i386/resolv.S interp.o vdl-file-reloc.o vdl-file-list.o vdl-gc.o vdl-file-symbol.o
